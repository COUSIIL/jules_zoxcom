...
$configPath = $_SERVER['DOCUMENT_ROOT'] . '/backend/config/yalConfig.php';
...
// URL de l’API Yalidine pour créer les colis
...
if (empty($response) || $decoded === null) {
    echo json_encode([
        'success' => false,
        'message' => 'Réponse invalide ou vide de l’API Yalidine.',
        'data' => $response
    ]);
    exit;
}

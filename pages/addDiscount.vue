    ...
    <div :style="{
        ...
        width: '100%'}" v-if="isMounted">
            ...
            <div class="boxContainer">
                ...
                <h4 style="display: flex; justify-content: space-between; align-items: center; flex-direction: column;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <button :class="created === true && limited === true && usage === true ? 'btn1' : 'btn2'" style="display: flex; justify-content: space-between; align-items: center; flex-direction: column; min-width: 100px; min-height: 80px;" type="button" @click="createUniqueCode(true, true)">
            ...
            <div class="boxContainer">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <button  :class="created === true && limited === true && usage === false ? 'btn1' : 'btn2'" style="display: flex; justify-content: space-between; align-items: center; flex-direction: column; min-width: 100px; min-height: 80px;" type="button" @click="createUniqueCode(false, true)">
                        <svg style="margin-inline: 5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
                            <path d="M18 2V4M6 2V4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M11.05 22C7.01949 22 5.00424 22 3.75212 20.6464C2.5 19.2927 2.5 17.1141 2.5 12.7568V12.2432C2.5 7.88594 2.5 5.70728 3.75212 4.35364C5.00424 3 7.01949 3 11.05 3H12.95C16.9805 3 18.9958 3 20.2479 4.35364C21.4765 5.68186 21.4996 7.80438 21.5 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M3 8H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
...
.boxList{
    ...
    border-radius: 6px;
    border: 1px dotted var(--color-hoggari);
    margin: 10px;
  }

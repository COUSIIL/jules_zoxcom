<template>
    <div style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column;">
                ...
                <div v-for="(product, index) in productList" :key="product.id">  
                    <div style="max-width: 200px; min-width: 200px; flex-direction: column; border-radius: 6px; box-shadow: 0px 2px 5px var(--color-rangy);">
                            ...
                            <img v-if="product.image.startsWith('https')" 
                                 ...
                                 style="max-width: 200px; max-height: 200px; min-width: 100px; min-height: 100px;"/>
                            <img v-else 
                        ...
                        <!-- Modèles de produit -->
                        <div class="list2" style="margin: 5px;">
                            <button class="btn2" style="max-width: 100px; min-width: 100px;" type="button" v-for="(model, i) in product.models" 
                                    :key="model.id" 
                                    @click="setProducts(index, i)">   
                                <div class="list" style="flex-direction: column; font-size: 2vh;">
                                    {{ model.modelName }}
        ...
        <div class="boxContainer">
            <form v-if="isMounted" @submit.prevent="saveOrder" style="width: 90%">
                <div v-if="selectedProd.length > 0" v-for="(product, index) in selectedProd" :key="product.id">
                    <div class="boxList">
                        ...
                        <div style="width: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 10px;">
                            <img class="inputImg2" v-if="product.image.startsWith('https')" 
                            :src="product.image" 
                            :alt="'product ' + i" 
                            />
                            <img v-else class="inputImg2" 
                            :src="'https://management.dinarz.shop' + product.image" 
                            :alt="'product ' + i" 
                            />
                            <div class="list2" style="max-height: 110px; margin-top: 10px;">
                        ...
                        <div v-for="(select, indexS) in product.selected" :key="indexS" style="width: 100%">
                            <div style="width: 100%; display: flex; justify-content: center; align-items: center;">
                                <div type="button"
                                class="bg-whity dark:bg-darky" 
                                style="width: 100px;
                                height: 80px;
                                border-radius: 6px;
                                margin: 10px;
                            ...
                            <div style="width: 100%; margin: 10px;">
                                <input class="input" style="min-width: 100%; margin-top: 10px;" type="number" v-model="select.qty" min="1"  @change="calculateDtails(index)" required>
                ...
                <div style="display: flex; justify-content: center; align-items: center; margin-block: 50px;">
                ...
                <h3 style="width: 90%; max-width: 450px; display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div v-if="country && method && index1 != -1" style="width: 100%; max-width: 450px; display: flex; justify-content: space-between; flex-direction: column; align-items: center;">
                        <h3 style="width: 90%; max-width: 450px; display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <select class="btn2" style="width: 90%; max-width: 450px;" v-model="select" required>
                    ...
                    <div v-if="deliveryPrice">
                        ...
                        <input class="input" type="text" v-model="sZone" required>

        
        

                        <h3 v-if="deliveryList[index1].adress_name" style="width: 90%; max-width: 450px; display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <input class="input" type="text" v-model="mZone">
                ...
                <div style="width: 90%; max-width: 450px; display: flex; justify-content: space-between; align-items: center; flex-direction: column;">
                    ...
                    <input class="discountInput" type="text" style="width: 90%; max-width: 450px;" v-model="test" @change="testDiscount">
                </div>
            ...
            <div v-if="total" style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column;">
                <div style="width: 100%; display: flex; justify-content: center; align-items: center; margin-block: 50px;">
